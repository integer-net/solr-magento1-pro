...
class IntegerNet_SolrPro_Model_Source_RobotOptions
{
    ...
    public function toOptionArray()
    {
        return array(
            ...
            array(
                ...
                'label' => Mage::helper('integernet_solrpro')->__('Search Result Page (always)'),
            ),
            array(
                'value' => self::ROBOT_OPTION_SEARCH_RESULTS_FILTERED,
                'label' => Mage::helper('integernet_solrpro')->__('Search Result Page with active Filters'),
            ),
            array(
                'value' => self::ROBOT_OPTION_CATEGORIES_FILTERED,
                'label' => Mage::helper('integernet_solrpro')->__('Category Page with active Filters'),
            ),
        );
    }
}